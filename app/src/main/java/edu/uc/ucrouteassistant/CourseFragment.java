...
public class CourseFragment extends Fragment {
    ...
    public void onResume(){
        ...
        edTxtCourseName.setText(courseName);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edTxtCourseName = view.findViewById(R.id.edTxtCourseName);
        edTxtCourseName.setInputType(InputType.TYPE_NULL);

        edTxtCourseName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                navigateToViewCourseFragment();
            }
        });
    ...
    private void navigateToViewCourseFragment(){
        Bundle bundle = new Bundle();
        bundle = requireArguments();
        Fragment fragment = new ViewCourseFragment();
        fragment.setArguments(bundle);
        FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
        fragmentTransaction.replace(R.id.fragmentListContainer, fragment, "ViewCourseFragment");
